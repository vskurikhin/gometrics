...
var (
	expected               = "very very very very very very very very very very very very very very long secret string"
...
func TestEncryptRSA(t *testing.T) {
	once = new(sync.Once)
	cfg := getTestConfigAgentCrypto()
	ca := GetAgentCrypto(cfg)
	once = new(sync.Once)
	cfg = getTestConfigServerCrypto()
	cs := GetServerCrypto(cfg)
